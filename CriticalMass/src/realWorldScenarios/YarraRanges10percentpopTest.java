...
public class YarraRanges10percentpopTest {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int probIteration = 1 ; probIteration <= 10 ; probIteration++)
		{
			...
			String [][] population = ZahraUtility.Data(46360, 3 , "G:\\My Drive\\1-PhDProject\\CriticalMass\\GM-MB\\YarraRangesPop20%.csv");
...
//					System.out.println("util: " + passengers.get(i).getUtility() + ", matched Veh: " +
//							passengers.get(i).getMtcheVehID());
//					if (passengers.get(i).getMtcheVehID() > -1)
//						System.out.println("Veh Capacity: " +
//							vehicles.get(passengers.get(i).getMtcheVehID()).capacity);
