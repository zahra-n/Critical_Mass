	...
	public static void main(String[] args) throws IOException {
		...
		for (int p = 10 ; p < 101 ; p+=10 )
		{
			for (int v = 5 ; v < 51 ; v+=5)	
			{
				...
				File plog = new File("final\\9sqkm\\" + area + "sqkm_probabilities.csv" );
		...
		//		pBufferedWriter.write("Area_sqKm,Population,Population_distribution,Vehicles_added_each_iteration,Vehicles_distribution,Success_probability\n");
				...
				{
					String dir = "final\\9sqkm\\P" + passDist + passengerNumber + "\\V" + vehDist + vehAddedInIteration + "\\" + probIteration + "\\" ;
		...
		//			System.out.println(probIteration);
				...
				pBufferedWriter.write(area + "," + passengerNumber /  area + "," + passDist + "," + vehAddedInIteration + "," + vehDist + "," + successProb + "\n");
