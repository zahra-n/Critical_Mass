...
//				System.out.println(featureMap.get("MB_CODE16").toString());
		...
		fileContent.append("point_ID,X,Y/n");
...
//				System.out.println(originCoord);
		...
		ZahraUtility.write2File(fileContent.toString(),"G:\\My Drive\\1-PhDProject\\CriticalMass\\GM-MB\\test.csv");//RandomPointsinMeshBlocks.csv");
